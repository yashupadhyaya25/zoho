...
timesheet_df = pd.read_excel('./Report_WO_Project_Task.xlsx',sheet_name='Sheet1')
timesheet_df = timesheet_df.T.reset_index().T
comm_df = timesheet_df.iloc[0:1]

excel_file = 'Report_WO_Project_Task.xlsx' 
...
wb.save('Report_WO_Project_Task_Commented.xlsx')