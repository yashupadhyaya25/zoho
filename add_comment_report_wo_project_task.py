...
timesheet_df = pd.read_excel('./New Reports/Report_WO_Project_Task.xlsx',sheet_name='Sheet1')
timesheet_df = timesheet_df.T.reset_index().T
comm_df = timesheet_df.iloc[0:1]

excel_file = './New Reports/Report_WO_Project_Task.xlsx' 
...
wb.save('./New Reports/Report_WO_Project_Task_With_Shadow_Comment.xlsx')