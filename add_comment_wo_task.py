...
timesheet_df = pd.read_excel('./HAH - Project wise Timesheet - Development.xlsx',sheet_name='Sheet1')
...
excel_file = 'HAH - Project wise Timesheet - Development.xlsx'
...
wb.save('PRJ_DEV_Commented.xlsx')