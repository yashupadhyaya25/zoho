...
timesheet_df = pd.read_excel('/Reports/Report_WO_Task.xlsx',sheet_name='Sheet1')
...
excel_file = '/Reports/Report_WO_Task.xlsx'
...
wb.save('/Reports/Report_WO_Task_With_Shadow_Comment.xlsx')