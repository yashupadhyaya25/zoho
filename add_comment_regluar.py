...
timesheet_df = pd.read_excel('./New Reports/Report_Project_Task.xlsx',sheet_name='Sheet1')
...
excel_file = './New Reports/Report_Project_Task.xlsx'
...
wb.save('./New Reports/Regular_Project_Task_With_Shadow_Comment.xlsx')