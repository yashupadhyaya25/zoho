...
time_sheet_df = time_sheet_df.loc[:, ~time_sheet_df.columns.isin(['Employee Id', 'Client Name','Email ID','Is Manual','Comment'])]
...
timesheet_transposed_df.to_excel('final.xlsx')